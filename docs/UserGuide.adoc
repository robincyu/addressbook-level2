...
* Sort the list (`sort` : sorts all persons by name)
...
Sorts the list of persons according to their names. +
Format: `sort [desc]`

****
Sorts the list of persons according to their names. It sorts in ascending order by default, but you
can pass `desc` to sort by descending order instead.
****
